...
#myModal .modal-dialog
{
  width: 55%;
    ...
    <link rel="shortcut icon" src="<?php echo base_url(); ?>assets/image/favicon.ico" />
  ...
  <body>
    <div class="container container-imtelkom">
      <div class="navbar navbar-default navbar-imtelkom">
        ...
        <li id="home_catalog"><a href="/home/katalog.html">Katalog</a></li> 
			 ...
			 <li id="home_gallery"><a href="/home/galery.html">Gallery</a></li>
              </ul>  </li>
    ...
    <h3>E-Journal & Magazine</h3>
			<div> 
				...
				<tr>
					...
					<td width="33%" align="left" colspan="2"><img src="<?php echo base_url(); ?>assets/images/ebsco.jpg"  width="40%"  title="EBSCO"></td>
				</tr>   
				...
				<tr>
					<td align="left" colspan="4" style="cursor:pointer"><img onclick="window.open('http://journals.telkomuniversity.ac.id', '_blank')" src="assets/images/journal_telkom_university.png" width="40%" title="Journals Telkom University"> <span  onclick="window.open('https://openlibrary.telkomuniversity.ac.id/olafa/index.php/sumberjurnal', '_blank')"><img src="https://openlibrary.telkomuniversity.ac.id/images/owl/48.png" title="E-Journal Nasional"> E-Journal Nasional </span>
				</tr>  		 
			...
			<div class="modal-content"> 
			  <div class="modal-body">
				...
				<table width="100%" style="background-color:#ccc;">
					<tr>
						<td width="80%" style="vertical-align:top;"><img src="<?php echo base_url();?>assets/images/infografik_ejurnal.jpg" width="100%"></td>
